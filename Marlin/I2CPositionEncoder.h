...
public:
	...
	FORCE_INLINE int get_error_count(void)
	{
		return errorCount;
	}
	...
	FORCE_INLINE bool get_active(void)
	{
		return active;
	}
	...
	FORCE_INLINE float get_axis_offset()
	{
		return axisOffset;
	}
...
FORCE_INLINE static void gcode_M860()
{
	I2CPEM.M860();
}
FORCE_INLINE static void gcode_M861()
{
	I2CPEM.M861();
}
FORCE_INLINE static void gcode_M862()
{
	I2CPEM.M862();
}
FORCE_INLINE static void gcode_M863()
{
	I2CPEM.M863();
}
FORCE_INLINE static void gcode_M864()
{
	I2CPEM.M864();
}
FORCE_INLINE static void gcode_M865()
{
	I2CPEM.M865();
}
FORCE_INLINE static void gcode_M866()
{
	I2CPEM.M866();
}
FORCE_INLINE static void gcode_M867()
{
	I2CPEM.M867();
}
FORCE_INLINE static void gcode_M868()
{
	I2CPEM.M868();
}
FORCE_INLINE static void gcode_M869()
{
	I2CPEM.M869();
}
