...
#define STRING_CONFIG_H_AUTHOR "ATMI" // Who made the changes.
...
// #define DISABLE_MAX_ENDSTOPS is Deprecated
...
/**
    ...
    Enable LCDKIND_CHARACTER for a 16x2, 16x4, 20x2, or 20x4 character-based LCD.
    Enable LCDKIND_GRAPHIC for a 128x64 (ST7565R) Full Graphical Display.
    (These options will be enabled automatically for most displays.)

    IMPORTANT: The U8glib library is required for Full Graphic Display!
              https://github.com/olikraus/U8glib_Arduino
*/
#define LCDKIND_CHARACTER   // Character based LCD support
//#define LCDKIND_GRAPHIC      // Full graphics display support
