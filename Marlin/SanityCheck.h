...
*/
	...
	#if DISABLED(LCDKIND_CHARACTER) && DISABLED(I2C_POSITION_ENCODERS)
...
*/
		...
		static_assert(NULL == strstr(FILAMENT_RUNOUT_SCRIPT, "M600"),
...
*/
#if DISABLED(LCDKIND_GRAPHIC) && ENABLED(LCDKIND_CHARACTER) && !defined(DISPLAY_CHARSET_HD44780)
...
*/
	...
	#elif ENABLED(DELTA_AUTO_CALIBRATION) && ENABLED(PROBE_MANUALLY) && DISABLED(USE_CONTROLLER)
...
*/
	...
	*/
			...
			static_assert(LEFT_PROBE_BED_POSITION >= -DELTA_PROBEABLE_RADIUS,
			"LEFT_PROBE_BED_POSITION must be within DELTA_PROBEABLE_RADIUS.");
			static_assert(RIGHT_PROBE_BED_POSITION <= DELTA_PROBEABLE_RADIUS,
			"RIGHT_PROBE_BED_POSITION must be within DELTA_PROBEABLE_RADIUS.");
			static_assert(FRONT_PROBE_BED_POSITION >= -DELTA_PROBEABLE_RADIUS,
			"FRONT_PROBE_BED_POSITION must be within DELTA_PROBEABLE_RADIUS.");
			static_assert(BACK_PROBE_BED_POSITION <= DELTA_PROBEABLE_RADIUS,
			"BACK_PROBE_BED_POSITION must be within DELTA_PROBEABLE_RADIUS.");
		#else
			static_assert(LEFT_PROBE_BED_POSITION < RIGHT_PROBE_BED_POSITION,
			"LEFT_PROBE_BED_POSITION must be less than RIGHT_PROBE_BED_POSITION.");
			static_assert(FRONT_PROBE_BED_POSITION < BACK_PROBE_BED_POSITION,
...
/**
    USE_CONTROLLER encoder
*/
#if ENABLED(USE_CONTROLLER) && DISABLED(NEWPANEL) && DISABLED(SR_LCD_2W_NL) && !defined(SHIFT_CLK)
	#error "USE_CONTROLLER requires some kind of encoder."
#endif
