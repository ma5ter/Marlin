...
public:
	...
	*/
	inline void onReceive(const twiReceiveFunc_t handler)
	{
	...
	/**
	    ...
	    @param handler A function to handle receiving bytes
	*/
	inline void onRequest(const twiRequestFunc_t handler)
	{
	...
	*/
	...
	inline void reply(const char str[])
	{
		this->reply((char *)str);
	}
	...
	*/
	...
	static inline void debug(const char func[], uint8_t v)
	{
		debug(func, (uint32_t)v);
	}
