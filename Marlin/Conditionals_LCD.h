...
// Helper macro to use old-style config (before refactoring of ULTRA_LCD to LCDKIND_CHARACTER)
	...
	#undef ULTRA_LCD
#endif
// Helper macro to use old-style config (before refactoring of DOGLCD to LCDKIND_GRAPHIC)
#if ENABLED(DOGLCD)
	#define LCDKIND_GRAPHIC
	#undef DOGLCD
#endif
// Check if both types of LSD are enabled at once
#if defined(LCDKIND_CHARACTER) && defined(LCDKIND_GRAPHIC)
...
// obsolete	#define ADC_KEY_NUM 8
	...
	#define LCDKIND_CHARACTER  //general LCD support, also 16x2
	#define LCDKIND_GRAPHIC  // Support for SPI LCD 128x64 (Controller ST7565R graphic Display Family)
...
// Generic support for SSD1306 / SH1106 OLED based LCDs.
	...
	#define LCDKIND_CHARACTER  //general LCD support, also 16x2
	#define LCDKIND_GRAPHIC  // Support for I2C LCD 128x64 (Controller SSD1306 / SH1106 graphic Display Family)
#endif
...
#if ENABLED(LCDKIND_GRAPHIC) // Change number of lines to match the DOG graphic display
	#ifndef LCD_WIDTH
		#define LCD_WIDTH 22
	#endif
	#ifndef LCD_HEIGHT
